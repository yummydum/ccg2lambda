...
USAGE="Usage: ./rte_en_mp_any_phrase.sh <sentences.txt> <semantic_templates.yaml>"
...
results_dir="phrase_results" # HTML semantic outputs, proving results, etc.
